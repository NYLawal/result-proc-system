...
const {addScores, addTermComment, getScores, getTermlyScores, getClassScores, updateScores, getScoresBySession, deleteScores, addStudentsComments, generatePositons, generateAttendance} 
...
router.route('/generatePosition').get([authenticateUser, adminORteacher], generatePositons)
router.route('/generateAttendance').get([authenticateUser, adminORteacher], generateAttendance)
